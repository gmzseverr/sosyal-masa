...
import { Home, Calendar, FileText, CreditCard, PartyPopper, MessageCircle, User } from "lucide-react"
    ...
    <div className="w-full max-w-4xl">
      <div className="mb-6">
        <div className="flex justify-between items-center mb-3">
          <span className="text-sm font-medium text-gray-700">Uygulama Akışı</span>
        ...
        <div className="w-full bg-gray-200 rounded-full h-3 shadow-inner">
          <motion.div
            ...
            initial={{ width: 0 }}
            animate={{
              width: `${Math.max(0, ((currentStepIndex + 1) / keySteps.length) * 100)}%`,
            }}
